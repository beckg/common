...
//BYTE USBSelfPower(void);
//BYTE USBBusSense(void);
...
//  must exist.
//#define USB_USER_DEVICE_DESCRIPTOR &device_dsca
//#define USB_USER_DEVICE_DESCRIPTOR_INCLUDE extern ROM USB_DEVICE_DESCRIPTOR device_dsca
